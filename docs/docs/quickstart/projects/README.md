...
[sksamuel/avro4k](https://github.com/lenguyenthanh/RxArrow): Avro format for kotlinx.serialization that has support for Arrow's data types

[sksamuel/hoplite](https://github.com/lenguyenthanh/RxArrow): A purely functional config library in the vein of Scala's pureconfig built on Arrow.
