...
Take a look at the [`EitherT` docs]({{ '/arrow/data/eithert' | relative_url }}) or [`OptionT` docs]({{ '/arrow/data/optiont' | relative_url }}) for an alternative version monad transformer for achieving different goals.
